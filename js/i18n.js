...
const dict = {
  ja: {
    ...
    gridFrameDone: '格子フレームを生成しました（柱 {columns}本・梁 {beams}本・床 {floors}枚・外壁 {walls}枚）。',
  ...
  en: {
    ...
    gridFrameDone: 'Grid frame generated (columns: {columns}, beams: {beams}, floors: {floors}, exterior walls: {walls}).',
